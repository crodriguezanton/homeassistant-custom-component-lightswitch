"""Tests for Lightswitch api."""
import asyncio

import aiohttp
from custom_components.lightswitch.api import (
    LightswitchApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = LightswitchApiClient("test", "test", async_get_clientsession(hass))
